...
export const flow_incendio: FlowSpec = {
  ...
  "risk": {
    ...
    "protectiveFactors": [
      "plano_de_abandono_treinado",
      "rotas_sinalizadas",
      "equipe_em_pontos_estrategicos"
    ],
    "riskSignals": [
      {
        "id": "fogo_visivel",
        ...
        "examples": [
          "chamas em equipamento",
          "fogo em lixeira ou rede eletrica"
        ],
        "weight": 3
      },
      {
      ...
      },
      {
        ...
        "examples": [
          "foco pequeno apagado rapidamente"
        ],
        "weight": 2
      }
    ],
