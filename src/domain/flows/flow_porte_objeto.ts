...
export const flow_porte_objeto: FlowSpec = {
  meta: {
    ...
    severity: 'HIGH',
    keywords: ['porte de objeto', 'arma', 'ameaca', 'protecao escolar'],
    status: 'EXISTING',
  },
  risk: {
    ...
    escalationRules: [
      {
        ...
        ifAny: ['objeto_letal', 'ameaca_de_uso'],
        then: {
          riskLevel: 'CRITICAL',
    ...
    protectiveFactors: ['equipe_treinada_em_crise', 'rotina_de_contencao_segura', 'apoio_da_gestao'],
    riskSignals: [
      {
        id: 'objeto_letal',
        label: 'Objeto com alto potencial de ferimento grave',
        examples: ['arma de fogo', 'faca de grande porte'],
        weight: 3,
      },
      {
        id: 'ameaca_de_uso',
        label: 'Ameaca verbal ou gestual de usar o objeto',
        examples: ['apontar objeto para colegas', 'falar que vai atacar'],
        weight: 3,
      },
      {
        id: 'posse_sem_ameaca_direta',
        label: 'Posse do objeto sem ameaca direta no momento',
        examples: ['objeto encontrado na mochila', 'porte sem exibicao agressiva'],
        weight: 2,
      },
    ],
    recommendedActionsByRisk: {
      MODERATE: ['Reavaliar contexto com a gestao', 'Registrar observacao inicial'],
      HIGH: ['Avisar gestao escolar', 'Entrar em contato com responsaveis', 'Registrar formalmente a ocorrencia'],
      CRITICAL: ['Acionar 190 imediatamente', 'Isolar area com seguranca', 'Nao deixar estudantes sozinhos'],
    },
  ...
  steps: [
    ...
    },
    {
      ...
      riskSignals: ['ameaca_de_uso', 'objeto_letal'],
    },
    {
      id: 'step_4',
      type: 'question',
      ...
      actions: [
        { label: 'Sim', next: 'outcome_contencao_segura' },
        { label: 'Nao ou situacao confusa', next: 'outcome_protecao_critica' },
      ],
      riskSignals: ['posse_sem_ameaca_direta'],
    },
  ],
  outcomes: [
    {
