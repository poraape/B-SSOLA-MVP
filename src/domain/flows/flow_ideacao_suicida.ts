...
export const flow_ideacao_suicida: FlowSpec = {
  meta: {
    ...
    severity: 'CRITICAL',
    keywords: ['ideacao suicida', 'risco grave', 'protecao imediata', 'acolhimento'],
    status: 'EXISTING',
  },
  risk: {
    ...
    escalationRules: [
      {
        ...
        ifAll: ['fala_intencao_clara', 'acesso_a_meio'],
        then: {
          riskLevel: 'CRITICAL',
      ...
      },
      {
        ...
        ifAny: ['desesperanca_intensa', 'isolamento_com_risco'],
        then: {
          riskLevel: 'HIGH',
    ...
    protectiveFactors: ['presenca_de_adulto_referencia', 'rede_familiar_acionada', 'acompanhamento_continuo'],
    riskSignals: [
      {
        id: 'fala_intencao_clara',
        label: 'Fala direta sobre se machucar ou morrer',
        examples: ['nao quero mais viver', 'vou me machucar hoje'],
        weight: 3,
      },
      {
        id: 'acesso_a_meio',
        label: 'Relato de plano e acesso a meio de autoagressao',
        examples: ['ja sei como fazer', 'tenho algo guardado para isso'],
        weight: 3,
      },
      {
        id: 'desesperanca_intensa',
        label: 'Desesperanca persistente com sofrimento evidente',
        examples: ['choro frequente', 'frases de sem saida'],
        weight: 2,
      },
      {
        id: 'isolamento_com_risco',
        label: 'Isolamento acentuado com perda de vinculo',
        examples: ['recusa de contato', 'afastamento abrupto da turma'],
        weight: 2,
      },
    ],
    recommendedActionsByRisk: {
      MODERATE: ['Escuta acolhedora e sem julgamento', 'Plano de acompanhamento com equipe', 'Registro de observacoes'],
      HIGH: ['Avisar gestao escolar', 'Entrar em contato com responsaveis', 'Encaminhar ao CAPS infantojuvenil'],
      CRITICAL: ['Acionar 192 imediatamente', 'Nao deixar o estudante sozinho', 'Garantir supervisao constante ate chegada de apoio'],
    },
    recommendedServiceTagsByRisk: {
      MODERATE: ['ASSISTENCIA_SOCIAL_ESCOLAR'],
      HIGH: ['CAPS_IJ', 'UBS'],
      CRITICAL: ['UPA_HOSPITAL', 'CAPS_IJ'],
    },
  },
  steps: [
    {
      ...
      riskSignals: ['fala_intencao_clara', 'desesperanca_intensa'],
    },
    {
      id: 'step_2',
      type: 'action',
      action: 'Permaneca com o estudante em local protegido e acione a gestao escolar.',
      riskSignals: ['isolamento_com_risco'],
    },
    {
      id: 'step_3',
      type: 'question',
      ...
      riskSignals: ['fala_intencao_clara', 'acesso_a_meio'],
    },
    {
      id: 'step_4',
      type: 'question',
      ...
      actions: [
        { label: 'Sim', next: 'outcome_apoio_prioritario' },
        { label: 'Nao', next: 'outcome_acompanhamento_continuo' },
      ],
      riskSignals: ['desesperanca_intensa', 'isolamento_com_risco'],
    },
  ],
  outcomes: [
    {
      ...
      timeline: 'Imediato',
      riskLevel: 'CRITICAL',
      serviceTags: ['UPA_HOSPITAL', 'CAPS_IJ'],
      flags: ['call_192', 'notify_management', 'notify_guardians', 'do_not_leave_alone', 'document_formal'],
    },
    {
    ...
    },
    {
      ...
      timeline: 'Dias',
      riskLevel: 'MODERATE',
      serviceTags: ['ASSISTENCIA_SOCIAL_ESCOLAR', 'UBS'],
      flags: ['document_formal', 'notify_management'],
    },
  ],
};
