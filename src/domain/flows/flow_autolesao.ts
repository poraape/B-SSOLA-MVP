...
export const flow_autolesao: FlowSpec = {
  meta: {
    ...
    severity: 'CRITICAL',
    keywords: ['autolesao', 'automutilacao', 'risco emocional grave', 'protecao imediata'],
    status: 'CONSOLIDATED',
  },
  risk: {
    ...
    escalationRules: [
      {
        ...
        ifAny: ['lesao_ativa', 'intencao_repetir_ato'],
        then: {
          riskLevel: 'CRITICAL',
      ...
      },
      {
        ...
        ifAny: ['historico_recorrente', 'sofrimento_intenso'],
        then: {
          riskLevel: 'HIGH',
    ...
    protectiveFactors: ['adulto_referencia_disponivel', 'plano_individual_de_apoio', 'rede_familiar_acionada'],
    riskSignals: [
      {
        id: 'lesao_ativa',
        label: 'Lesao recente ou comportamento de autoagressao no momento',
        examples: ['ferimento aparente', 'tentativa de se machucar na escola'],
        weight: 3,
      },
      {
        id: 'intencao_repetir_ato',
        label: 'Fala de repetir autolesao em curto prazo',
        examples: ['vou fazer de novo hoje', 'nao consigo parar'],
        weight: 3,
      },
      {
        id: 'historico_recorrente',
        label: 'Historico repetido de autolesao',
        examples: ['episodios frequentes nas ultimas semanas'],
        weight: 2,
      },
      {
        id: 'sofrimento_intenso',
        label: 'Sofrimento emocional intenso e persistente',
        examples: ['choro frequente', 'isolamento com desesperanca'],
        weight: 2,
      },
    ],
    recommendedActionsByRisk: {
      MODERATE: ['Escuta acolhedora e sem julgamento', 'Registro no acompanhamento escolar', 'Plano de cuidado com equipe'],
      HIGH: ['Avisar gestao escolar', 'Entrar em contato com responsaveis', 'Encaminhar ao CAPS infantojuvenil'],
      CRITICAL: ['Acionar 192 imediatamente', 'Nao deixar a pessoa sozinha', 'Garantir supervisao continua'],
    },
  ...
  steps: [
    {
      ...
      riskSignals: ['lesao_ativa', 'sofrimento_intenso'],
    },
    {
      id: 'step_2',
      type: 'action',
      action: 'Permaneca com o estudante em local protegido e acione a gestao escolar.',
      riskSignals: ['lesao_ativa', 'intencao_repetir_ato'],
    },
    {
      id: 'step_3',
      type: 'question',
    ...
    },
    {
      ...
      actions: [
        { label: 'Sim', next: 'outcome_rede_apoio_prioritaria' },
        { label: 'Nao', next: 'outcome_acompanhamento_protegido' },
      ],
      riskSignals: ['historico_recorrente', 'sofrimento_intenso'],
    },
  ],
  outcomes: [
    {
