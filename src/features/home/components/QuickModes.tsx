...
export const QuickModes: React.FC<QuickModesProps> = ({
  ...
  return (
    <section className="space-y-4 rounded-[20px] border border-slate-200/70 bg-white/45 p-4 shadow-[0_16px_36px_-26px_rgba(15,23,42,0.35)] backdrop-blur-xl dark:border-slate-700/70 dark:bg-slate-900/35 sm:space-y-5 sm:p-5 md:p-6">
      ...
      <div className="grid grid-cols-1 gap-3.5 sm:gap-4 md:grid-cols-3">
        <Card hoverable onClick={onStartGuidedCare} className={`group min-h-[7rem] rounded-[20px] border p-4 shadow-[0_10px_24px_-18px_rgba(15,23,42,0.45)] backdrop-blur-md transition-all hover:scale-[1.03] sm:min-h-[7.5rem] sm:p-5 ${baseCardClass}`}>
        ...
        <Card hoverable onClick={onOpenNetwork} className={`group min-h-[7rem] rounded-[20px] border p-4 shadow-[0_10px_24px_-18px_rgba(15,23,42,0.45)] backdrop-blur-md transition-all hover:scale-[1.03] sm:min-h-[7.5rem] sm:p-5 ${baseCardClass}`}>
        ...
        <Card hoverable onClick={onOpenResources} className={`group min-h-[7rem] rounded-[20px] border p-4 shadow-[0_10px_24px_-18px_rgba(15,23,42,0.45)] backdrop-blur-md transition-all hover:scale-[1.03] sm:min-h-[7.5rem] sm:p-5 ${baseCardClass}`}>
