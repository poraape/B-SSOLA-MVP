...
/**
 * Pesquisa conteúdos de FAQ por relevância textual.
 * @param {string} query - Termo informado pelo usuário.
 * @returns {FAQSearchResult[]} Lista ordenada de resultados de FAQ.
 */
...
/**
 * Pesquisa termos e definições do glossário por texto livre.
 * @param {string} query - Termo informado pelo usuário.
 * @returns {GlossarySearchResult[]} Lista ordenada de resultados de glossário.
 */
...
/**
 * Executa busca unificada em FAQ, Glossário e Decisor.
 * @param {string} query - Termo informado pelo usuário.
 * @returns {UnifiedSearchResult[]} Resultados combinados ordenados por score.
 */
...
/**
 * Filtra os resultados da busca unificada por tipo de conteúdo.
 * @param {string} query - Termo informado pelo usuário.
 * @param {SearchFilterType} type - Tipo de filtro selecionado.
 * @returns {UnifiedSearchResult[]} Resultados compatíveis com o filtro.
 */
